...
public class OscarReviewResource {
    ...
    public Response listOscarReviewsByUsername(@PathParam("username") String username) {
        return Response.ok(_oscarReviewRepository.findAllByUsername(username)).build();
    }
